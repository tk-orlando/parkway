...
<form action="<?php echo $this->action; ?>" method="post" name="adminForm" id="adminForm">
    ...
    <thead>
        <tr>
            <th>
                <?php echo JHtml::_('grid.sort', 'COM_PARKWAY_SUITEPLANS_HEADING_TITLE', 'title'); ?>
            </th>
            <th>
                <?php echo JHtml::_('grid.sort', 'COM_PARKWAY_SUITEPLANS_HEADING_BUILDINGNAME', 'building_name' ); ?>
            </th>
            <th>
                <?php echo JHtml::_('grid.sort', 'COM_PARKWAY_SUITEPLANS_HEADING_PROPERTYNAME', 'property_name'); ?>
            </th>
            
            <th width="5">
                <?php echo JHtml::_('grid.sort', 'COM_PARKWAY_SUITEPLANS_HEADING_ID', 'id'); ?>
            </th>
        </tr>
    </thead>
    <tfoot>
