...
class ParkwayViewFloorplan extends JViewLegacy
{
    ...
    protected function addToolbar()
    {
		...
		if ($isNew)
		{
			$title = JText::_('COM_PARKWAY_MANAGER_FLOORPLAN_NEW');
		}
		else
		{
			$title = JText::_('COM_PARKWAY_MANAGER_FLOORPLAN_EDIT');
		}
...
// Get the toolbar object instance
            ...
            JToolbarHelper::title(JText::_('Parkway: Floorplan'), 'floorplan');
            //JToolbarHelper::addNew('property.save');
            //JToolbarHelper::apply('property.apply');
            JToolbarHelper::save('floorplan.save');
            JToolBarHelper::cancel('floorplan.cancel',
