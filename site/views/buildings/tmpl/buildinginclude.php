        ...
        <div class="uk-grid">
            <div class="uk-width-medium-1-2">
                ...
                <?php if (isset($value->imagethumb) && !empty($value->imagethumb)): ?>
                    ...
                    <img class="results-thumb" src="<?php echo '/media/com_parkway/' . $value->imagethumb ?>"
                         alt="<?php echo $value->imagethumb ?>">
                <?php elseif (isset($value->image) && !empty($value->image)): ?>

                    <img class="results-thumb" src="<?php echo '/media/com_parkway/' . $value->image ?>"
                         alt="<?php echo $value->image ?>">
                <?php else: ?>

                    <img class="results-thumb" src="/components/com_parkway/images/thumb-placeholder.jpg"
                         alt="placeholder">
            ...
            <div class="uk-width-medium-1-2 uk-margin-bottom">
                ...
                <?php if (isset($value->fact_sheet) && !empty($value->fact_sheet) && ($value->show_fact_sheet == 1)): ?>
                    ...
                    <a class="uk-icon-file-pdf-o uk-margin-small-bottom"
                       href="<?php echo JRoute::_('/media/com_parkway/' . $value->fact_sheet) ?>"><span class="uk-h5">Fact Sheet</span></a>
                    <br/>
