...
(function (define) {
	...
	: function (factory) {
		...
		: (pjQ.jQuery.mapster_when = factory());
	}
...
(function ($) {
    ...
    $.fn.mapster = function (method) {
        ...
        if ($.isFunction(m[method])) {
            ...
            $.error('Method ' + method + ' does not exist on pjQ.jQuery.mapster');
        }
    };
...
(function ($) {
    ...
    m.MapData.prototype = {
        ...
        buildDataset: function(rebind) {
            ...
            // the [attribute] selector is broken on old IE with pjQ.jQuery. hasVml() is a quick and dirty
